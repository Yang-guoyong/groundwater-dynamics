...
$$
\small
s = \frac{Q}{4\pi T}\left\{ \frac{4\pi}{l}\sqrt{\frac{Tt}{S}}f(\lambda) + ln\left( \frac{e^{\frac{2\pi y}{l}}}{4\left\lbrack \cosh\frac{\pi y}{l} - \cos\frac{\pi(x + a)}{l} \right\rbrack\left\lbrack \cosh\frac{\pi y}{l} - \cos\frac{\pi(x - a)}{l} \right\rbrack} \right) \right\}
$$
